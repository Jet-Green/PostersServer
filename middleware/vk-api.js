...
module.exports = {
    async postInGroup(message) {
        let response = await axios.post(`https://api.vk.com/method/wall.post?access_token=${process.env.VK_ACCESS_TOKEN}&v=5.131&attachments=${message}&message=${message}&from_group=1`)
        return response
    }
} 
