...
router.get('/get-posters-miniature', PosterController.getPostersMiniature)
router.post('/get-active-categories', PosterController.getActiveCategories)
router.get('/get-active-cities', PosterController.getActiveCities)
...
router.get('/get-manager-posters-on-moderation', authMiddleware, PosterController.getManagerPostersOnModeration)
